...
def test_signup(app, get_user):
    ...
    assert response.json["data"]["attributes"]["email"] == test_user["email"]
...
def test_protected_resource(app, get_user):
    test_user = get_user
    response = app.post("/user/signup", data=json.dumps(test_user), headers=headers)
    response = app.post("/user/login", data=json.dumps(test_user), headers=headers)
...
def test_login_badrequest(app, get_user):
    test_user = get_user
    response = app.post("/user/signup", data=json.dumps(test_user), headers=headers)
...
def test_signup_conflict(app, get_user):
    test_user = get_user
...
def test_login_notfound(app, get_user):
    test_user = get_user
    response = app.post("/user/login", data=json.dumps(test_user), headers=headers)
...
def test_delete_user(app, get_user):
    test_user = get_user
